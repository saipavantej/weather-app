...
ELEMENTS.ELEMENT_WEATHER_BOX.style.display = 'block';
 const APP_ID = '109c6f66f7ec8391c388d3ca979c494c';

 const click = ELEMENTS.ELEMENT_SEARCH_BUTTON.addEventListener('click', searchWeather);
 function searchWeather() {
   const CITY = ELEMENTS.ELEMENT_SEARCHED_CITY;
    ...
    Http.fetchData(URL)
        .then(responseData => {
            const WEATHER_DATA = new WeatherData(CITY_NAME.toUpperCase(), responseData.weather[0].description.toUpperCase());
